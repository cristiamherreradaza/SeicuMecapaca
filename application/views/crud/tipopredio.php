                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body wizard-content">
                            <div class="col-lg-2 col-md-4">
                                <button type="button" class="btn btn-block btn-lg btn-success" data-toggle="modal" data-target="#Modal_insert">Nuevo Tipo Predio</button>
                            </div><div class="card">
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div id="derecha"><a href="<?= base_url('tipopredio/eliminar/'. $lis->tipo_predio_id); ?>"><i class="fas fa-trash-alt"></i>Borrar</a></div>
                                                </td>
                                            </tr>
                                        <?php 
                                         }
