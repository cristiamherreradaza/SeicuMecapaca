                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="documento_table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php $i=1;?>                                                
                                            <?php foreach ($data_tcorr as $row) {  ?>
                                            <tr>
                                                <td><?php echo $i++; ?></td>
                                                <td><?php echo $row->descripcion; ?></td>
                                                <td>                                           
                                                <?php if (($row->activo)==1):?>
                                                        <a <?php echo $verifica['baja'];?>="<?php echo site_url('tipo_tramite_doc/delete'); ?>/<?php echo $row->tipo_actuacion_id; ?>"><button type="button" class="btn btn-success"><span class="fas fa-arrow-alt-circle-up" aria-hidden="true"></span> Activo</button></a>                                                          
                                                    <?php endif ?>
                                                    <?php if (($row->activo)==0):?>
                                                        <a <?php echo $verifica['baja'];?>="<?php echo site_url('tipo_tramite_doc/delete'); ?>/<?php echo $row->tipo_actuacion_id; ?>"><button type="button" class="btn btn-danger"><span class="fas fa-arrow-alt-circle-down" aria-hidden="true"></span> Inactivo</button></a>                                                          
                                                    <?php endif ?>
                                                </td>                                                                                                              
                                                <td>
